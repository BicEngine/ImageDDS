...
final class DDSPixelFormat
{
     ...
     *                              of the {@see DDSHeaderDXT10} extended header, and the {@see DDSHeaderDXT10::$dxgiFormat} member of
     *                              that structure indicates the true format. When using a four-character
     *                              code, {@see DDSPixelFormat::$flags} must include {@see Flag::FOURCC}.
     * @param int $rgbBitCount      Number of bits in an RGB (possibly including alpha) format. Valid
     *                              when {@see DDSPixelFormat::$flags} includes {@see Flag::RGB}, {@see Flag::LUMINANCE},
     *                              or {@see Flag::YUV}.
     ...
     * @param int $aBitMask         Alpha mask for reading alpha data. The {@see DDSPixelFormat::$flags} must
